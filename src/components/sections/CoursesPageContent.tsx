...
const getCategory = (id: string) => {
  if (id === "web") return "Development";
  if (id === "graphic") return "Creative";
  if (id === "tally") return "Accounting";
  if (id === "adca" || id === "dca") return "Professional";
  if (id === "office" || id === "typing" || id === "fundamentals") return "Skills";
  return "General";
};

const categories = ["All", "Professional", "Accounting", "Development", "Creative", "Skills"];

export function CoursesPageContent({ initialCourses }: { initialCourses: Course[] }) {
  ...
  const filteredCourses = courses.filter(course => {
    ...
    const matchesSearch = course.title.toLowerCase().includes(searchQuery.toLowerCase()) || 
                         (course as any).fullName?.toLowerCase().includes(searchQuery.toLowerCase()) ||
